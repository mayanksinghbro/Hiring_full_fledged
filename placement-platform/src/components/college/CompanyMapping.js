        ...
        <div className="bg-white rounded-[16px] p-6">
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p className="text-[13px] text-gray-500">AI-matched top students (overriding CGPA metrics)</p>
                </div>
            </div>
            ...
            <div className="mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-5 gap-3">
                    {visitingCompanies.map((c) => (
                        ...
                        >
                            <p className={`font-bold text-[13px] ${selectedCompanyId === c.id ? 'text-[#2563EB]' : 'text-gray-700'}`}>{c.name}</p>
